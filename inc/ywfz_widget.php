		...
		{ 
			...
			?>
			 <div class="gallery clearfix">
				<a href="<?php echo $data->ywfz_watch; ?>" rel="g_ywfz[gallery]" title="<?php echo $data->ywfz_title; ?>"> 
					<?php echo $imgsource; ?>
				</a> 
			</div>
			<?php
			...
			{
			 	$hidden =  $hidden .'<a href="' . $data->ywfz_watch . '" rel="g_ywfz[gallery]" title="'. $data->ywfz_title . '"></a>';
			}
			$i = $i + 1;
		}
	}
