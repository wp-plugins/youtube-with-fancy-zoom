...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr>
    ...
    <td width="39%" rowspan="11" align="center" valign="top"><?php if (function_exists (gads)) gads(); ?><br />
      See help page to remove this ad</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<a target="_blank" href="http://gopi.coolpage.biz/demo/2009/10/10/youtube-with-fancy-zoom/">Help</a>	</td>
    </tr>
  <tr>
    <td>If (http://www.youtube.com/watch?v=Vc6V4b4VgOk) this is your youtube video
      <br />then &ldquo;Vc6V4b4VgOk&rdquo; is your youtube code.</td>
  </tr>
  <tr>
 ...
 <!-- <tr>
  ...
  <tr>
    <td height="35" align="left" valign="bottom"><input name="publish" lang="publish" class="button-primary" value="<?php echo $submittext?>" type="submit" /></td>
    </tr>
</table>
