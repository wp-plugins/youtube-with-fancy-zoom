...
function g_ywfz_install() 
{
	...
	if($wpdb->get_var("show tables like '". WP_G_YWFZ_TABLE . "'") != WP_G_YWFZ_TABLE) 
	{
		$wpdb->query("
			...
			");
		$sSql = "insert into `". WP_G_YWFZ_TABLE . "` set `ywfz_title`='Beijing 2008 Closing Ceremony', ";
		$sSql = $sSql . "`ywfz_watch`='http://www.youtube.com/watch?v=uAoEFa3aTpI', ";
		$sSql = $sSql . "`ywfz_code`='uAoEFa3aTpI', ";
