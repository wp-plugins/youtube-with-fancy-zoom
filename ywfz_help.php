...
&lt;?php if (function_exists (g_ywfz_show)) g_ywfz_show(); ?&gt;</code><br /><br />

3.Now you can add this fancy zoom vide in pages and post. Use below code in post and page.<br />
<code>[YoutubeFancyZoom=LxvApfkScLg]</code>	<br />
LxvApfkScLg = this you tube code(see Manage Page page to find the code)
